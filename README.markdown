...
* remove vraptor-gae.jar! this project contains the only fix needed to run on the mentioned environment ([check this issue for more information] (https://github.com/caelum/vraptor/issues/410))
